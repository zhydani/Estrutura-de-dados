...
public class Q2 {
	 ...
	 * operações que façam o seguinte: b - Definir i com o segundo elemento a partir
	 * do topo da pilha, deixando a pilha inalterada.
	 */
	public static void main(String[] args) {
		...
		int aux = p.remover();
		// removendo o primeiro elemento a partir do do topo (e salvando em uma
		// variável)
		int aux2 = p.remover();
