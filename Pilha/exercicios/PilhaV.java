...
/**
 * 
 * @author luis araujo Implementação de uma pilha baseada em vetor genérico
...
public class PilhaV<T> {
	...
	public PilhaV(int max) {
		// instanciando um vetor genérico (cria um vetor do tipo Objetc e faz o cast
		// (conversão) para o tipo T
